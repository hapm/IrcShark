// <copyright file="Completion.cs" company="IrcShark Team">
...
namespace IrcShark.Extensions.Terminal
{
    ...
    public struct Completion
    {
		...
		/// </summary>
		/// <param name="prefix">The prefix that ws to complete.</param>
		/// <param name="result">The result of the completion.</param>
