...
namespace IrcShark
{
	...
	public class LogMessage
	{
		...
		/// <summary>
		/// Initialises a new log message withe the given text on the given channel
		/// </summary>
		/// <param name="channel">
		...
		/// <summary>
		/// Initialises a new log message withe the given text and level on the given channel
		/// </summary>
		/// <param name="channel">
		/// The name of the channel the message was logged to
		/// </param>
